          ...
          <div>
            <div className={styles.center}>
              <div className={styles.title}>
                <h1 className="ff-serif fs-700">Privacy Policy</h1>
                <h2 className="fs-500">for joanne.com</h2>
              </div>
              <div className={styles.title}>
                <p>
                  At Joanne, accessible from{' '}
                  <Link className="ff-serif fw" href="/">
                    https://joanne.com/
                  </Link>
                  , one of our main priorities is the privacy of our visitors.
                  This Privacy Policy document contains types of information
                  that is collected and recorded by Joanne and how we use it.
                </p>
                <p>
                ...
                <p>
                  ...
                  information that they shared and/or collect in Joanne. This
                  policy is not applicable to any information collected offline
                  or via channels other than this website.
                </p>
              </div>
              <h3 className="ff-serif fs-500 fw">Consent</h3>
              <p>
                By using our website, you hereby consent to our Privacy Policy
                and agree to its terms.
              </p>
              <h4 className="ff-serif fs-500 fw">Information we collect</h4>
              <p>
              ...
              <h5 className="ff-serif fs-500 fw">
              ...
              <p>
                Joanne follows a standard procedure of using log files. These
              ...
              <h6 className="ff-serif fs-500 fw">Cookies and Web Beacons</h6>
              <p>
                Like any other website, Joanne uses "cookies". These cookies are
              ...
              <h6 className="ff-serif fs-500 fw">
              ...
              <p>
                ...
                <Link
                  className="ff-serif fw"
                  href="https://policies.google.com/technologies/ads">
                  https://policies.google.com/technologies/ads
                </Link>
              </p>
              <h6 className="fw">Advertising Partners Privacy Policies</h6>
              <p>
                You may consult this list to find the Privacy Policy for each of
                the advertising partners of Joanne.
              </p>
              <p>
                Third-party ad servers or ad networks uses technologies like
                cookies, JavaScript, or Web Beacons that are used in their
                respective advertisements and links that appear on JMT
                Creations, which are sent directly to users' browser. They
              ...
              <p>
                Note that Joanne has no access to or control over these cookies
              ...
              <p>
                Joanne's Privacy Policy does not apply to other advertisers or
              ...
              <h6 className="ff-serif fs-500 fw">Children's Information</h6>
              <p>
              ...
              <p>
                Joanne does not knowingly collect any Personal Identifiable
              ...
              <h6 className="ff-serif fs-500 fw">Contact Us</h6>
              <p>
