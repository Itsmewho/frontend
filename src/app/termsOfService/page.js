        ...
        <div className="page-wrapper">
          <div className={styles.center}>
            <div className={styles.title}>
              <h1 className="ff-serif fs-900 black">TERMS OF SERVICE</h1>
              <h2 className="ff-serif fs-500 black">
                Last updated May 01, 2024
              </h2>
              <h3 className="ff-serif black">AGREEMENT TO OUR LEGAL TERMS</h3>
            </div>
            <p>
              We are Joanne ("Company," "we," "us," "our"), a company registered
              in the Netherlands at __________, Meppel. We operate the website
              https://Joanne.com/ (the "Site"), as well as any other related
              products and services that refer or link to these legal terms (the
              "Legal Terms") (collectively, the "Services"). I provide services
              in webdesign and deployment for B2C. And for fun projects
              downloadables You can contact us by email at joanne@joanne.com or
              by mail to __________, These Legal Terms constitute a legally
              binding agreement made between you, whether personally or on
              behalf of an entity ("you"), and Joanne, concerning your access to
              ...
              MUST DISCONTINUE USE IMMEDIATELY. Supplemental terms and
              conditions or documents that may be posted on the Services from
              time to time are hereby expressly incorporated herein by
              reference. We reserve the right, in our sole discretion, to make
              changes or modifications to these Legal Terms from time to time.
              ...
              Legal Terms are posted. The Services are intended for users who
              ...
              must have your parent or guardian read and agree to these Legal
              Terms prior to you using the Services. We recommend that you print
            ...
            <h4 className="ff-serif fw">2. INTELLECTUAL PROPERTY RIGHTS</h4>
            <p>
              ...
              and treaties in the United States and around the world. The
            ...
            <p>
              ...
              <span className="fw">joanne@Joanne.com.</span> If we ever grant
              ...
              posting, reproducing, or displaying our Content. We reserve all
            ...
            <p>
              ...
              have received parental permission to use the Services; (4) you
              ...
              the Services for any illegal or unauthorized purpose; and (6) your
            ...
            <h4 className="fw">4. PRODUCTS</h4>
            <p>
              All products are digital. We reserve the right to discontinue any
              products at any time for any reason. Prices for all products are
              subject to change.
            </p>
            <h4 className="fw">5. PURCHASES AND PAYMENT</h4>
            ...
            <p>
              ...
              time. All payments shall be in Euros. You agree to pay all charges
              at the prices then in effect for your purchases and any applicable
              shipping fees, and you authorize us to charge your chosen payment
              provider for any such amounts upon placing your order. If your
              order is subject to recurring charges, then you consent to our
              charging your payment method on a recurring basis without
              requiring your prior approval for each recurring charge, until
              such time as you cancel the applicable order. We reserve the right
              to correct any errors or mistakes in pricing, even if we have
              already requested or received payment. We reserve the right to
              ...
              placed by or under the same customer account, the same payment
              method, and/or orders that use the same billing or shipping
              address. We reserve the right to limit or prohibit orders that, in
              our sole judgment, appear to be placed by dealers, resellers, or
              distributors.
            </p>
            <h4 className="fw">6. REFUNDS POLICY</h4>
            <p> All sales are final and no refund will be issued.</p>
            <h4 className="fw">7. PROHIBITED ACTIVITIES</h4>
            <p>
              {' '}
            ...
            <p>
              As a user of the Services, you agree not to: Systematically
              ...
              the Services. Use any information obtained from the Services in
              order to harass, abuse, or harm another person. Make improper use
              of our support services or submit false reports of abuse or
              misconduct. Use the Services in a manner inconsistent with any
              applicable laws or regulations. Engage in unauthorized framing of
              or linking to the Services. Upload or transmit (or attempt to
              ...
              or other proprietary rights notice from any Content. Attempt to
              ...
              providing any portion of the Services to you. Attempt to bypass
              any measures of the Services designed to prevent or restrict
              access to the Services, or any portion of the Services. Copy or
              adapt the Services' software, including but not limited to Flash,
              ...
              part of the Services. Except as may be the result of standard
              ...
              other software. Use a buying agent or purchasing agent to make
              purchases on the Services. Make any unauthorized use of the
              ...
              under false pretenses. Use the Services as part of any effort to
              compete with us or otherwise use the Services and/or the Content
              for any revenue-generating endeavor or commercial enterprise. Use
              the Services to advertise or offer to sell goods and services.
              Sell or otherwise transfer your profile.
            </p>
            <h4 className="fw">8. USER GENERATED CONTRIBUTIONS</h4>
            <p>
              {' '}
              ...
              Legal Terms. You have the written consent, release, and/or
              ...
              these Legal Terms. Your Contributions are not false, inaccurate,
              or misleading.
            </p>
            <ul>
            ...
            <h4 className="fw">9. CONTRIBUTION LICENSE</h4>
            <p>
              ...
              other proprietary rights associated with your Contributions. We
            ...
            <h4 className="fw">10. GUIDELINES FOR REVIEWS</h4>
            <p>
              ...
              Reviews are not endorsed by us, and do not necessarily represent
              our opinions or the views of any of our affiliates or partners. We
            ...
            <h4 className="fw">11. THIRD-PARTY WEBSITES AND CONTENT</h4>
            <p>
            ...
            <h4 className="fw">12. SERVICES MANAGEMENT</h4>
            <p>
            ...
            <h4 className="fw">13. PRIVACY POLICY</h4>
            <p>
              We care about data privacy and security. Please review our Privacy
              Policy: <Link href="/privacy">https://joanne.com/privacy</Link>.
              By using the Services, you agree to be bound by our Privacy
              Policy, which is incorporated into these Legal Terms. Please be
              advised the Services are hosted in the Netherlands. If you access
              ...
              transferring your data to the Netherlands, and you expressly
              consent to have your data transferred to and processed in the
              Netherlands. Further, we do not knowingly accept, request, or
            ...
            <h4 className="fw">14. TERM AND TERMINATION</h4>
            <p>
            ...
            <h4 className="fw">15. MODIFICATIONS AND INTERRUPTIONS</h4>
            <p>
              ...
              Services. We cannot guarantee the Services will be available at
              all times. We may experience hardware, software, or other problems
              or need to perform maintenance related to the Services, resulting
              in interruptions, delays, or errors. We reserve the right to
              change, revise, update, suspend, discontinue, or otherwise modify
              the Services at any time or for any reason without notice to you.
            ...
            <p>
              ...
              country to residence. Joanne and yourself both agree to submit to
              the non-exclusive jurisdiction of the courts of Drenthe, which
              means that you may make a claim to defend your consumer protection
              rights in regards to these Legal Terms in the Netherlands , or in
              the EU country in which you reside.
            </p>
            <h4 className="fw">17. DISPUTE RESOLUTION</h4>
            <p>
              Informal Negotiations To expedite resolution and control the cost
              of any dispute, controversy, or claim related to these Legal Terms
              ...
              notice from one Party to the other Party. Binding Arbitration Any
              dispute arising from the relationships between the Parties to
              ...
              of arbitration shall be Meppel, Netherlands. The language of the
              proceedings shall be Dutch. Applicable rules of substantive law
              shall be the law of the Netherlands. Restrictions The Parties
              ...
              no arbitration shall be joined with any other proceeding; (b)
              there is no right or authority for any Dispute to be arbitrated on
              a className-action basis or to utilize className action
              ...
              informal negotiations binding arbitration: (a) any Disputes
              seeking to enforce or protect, or concerning the validity of, any
            ...
            <h4 className="fw">18. CORRECTIONS</h4>
            <p>
            ...
            <h4 className="fw">19. DISCLAIMER</h4>
            <p>
            ...
            <h4 className="fw">20. LIMITATIONS OF LIABILITY</h4>
            <p>
              ...
              THE AMOUNT PAID, IF ANY, BY YOU TO US OR $10.00 USD. CERTAIN US
            ...
            <h4 className="fw">21. INDEMNIFICATION</h4>
            <p>
            ...
            <h4 className="fr">22. USER DATA</h4>
            <p>
            ...
            <h4 className="fw">24. CALIFORNIA USERS AND RESIDENTS</h4>
            <p>
              If any complaint with us is not satisfactorily resolved, you can
              contact the Complaint Assistance Unit of the Division of Consumer
              Services of the California Department of Consumer Affairs.
              <Link href="/contact">click here for contact info</Link>
            </p>
            <h4 className="fw">25. MISCELLANEOUS</h4>
            <p>
              {' '}
            ...
            <h4 className="fw">26. CONTACT US</h4>
            <p>
            ...
            <p>
              I as Joanne ("Company," "we," "us," "our"), a company registered
              in the Netherlands at __________, Meppel.
            </p>
            <p>
              {' '}
              We operate the website <span>https://Joanne.com/ </span> (the
              "Site"), as well as any other related products and services that
              refer or link to these legal terms (the "Legal Terms")
              (collectively, the "Services").
            </p>
            <p>
              I provide services in webdesign and deployment for B2C. And for
              fun projects downloadables
            </p>
            <p>
              You can contact us by email at{' '}
              <Link href="/contact">Click here for contact</Link>
            </p>
            <p>
              These Legal Terms constitute a legally binding agreement made
              between you, whether personally or on behalf of an entity ("you"),
              and Joanne, concerning your access to and use of the Services. You
              agree that by accessing the Services, you have read, understood,
